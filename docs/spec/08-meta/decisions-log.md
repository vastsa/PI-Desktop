...
- The in-flow shell treats MainChat as the first-priority column: a hard 360px
  minimum, a panel capped at `min(720px, client width - 360px - expanded
  sidebar)`, and an expanded sidebar that yields at the threshold while its
...
- Decision D408 records the issue #267 behavior. See ADR 0237 and
