...
| 0308 | [User-authored `@agent` delegation](0308-composer-agent-mention.md) | Accepted for implementation (adds the composer's delegation entry point; no change to the `Task` contract) |
