# ADR 0249 — Deny-first permission rules

- **Status**: Accepted for implementation
- **Date**: 2026-09-15
- **Related**: D115, D420, `03-runtime/03-tools-and-permissions.md` §6, `03-runtime/05-host-core-rust.md` §6, `03-runtime/06-host-rpc-protocol.md` `tools.execute`, `07-plugins/02-plugin-manifest-schema.md` §4–5, `07-plugins/04-plugin-security.md` §3.3, `07-plugins/13-plugin-permissions-matrix.md`
