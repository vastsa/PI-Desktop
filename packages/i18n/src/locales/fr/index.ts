...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
  ...
  "remote": {
    "badge": "Distant",
    "sidebarSection": "Hôtes distants",
    "connected": "Connecté",
    "disconnected": "Hors ligne",
    "newSession": "Nouvelle session distante",
    "noSessions": "Aucune session sur cet hôte",
    "newSessionTitle": "Nouvelle session sur {{host}}",
    "newSessionDescription": "Choisissez un projet sur l’hôte. La session s’y exécute avec le modèle par défaut de l’hôte.",
    "projects": "Projets de l’hôte",
    "loadingProjects": "Chargement des projets…",
    "noProjects": "Cet hôte n’a pas encore de projet. Parcourez les dossiers pour en ajouter un.",
    "browseFolder": "Parcourir les dossiers…",
    "browseDirectories": "Dossiers de l’hôte",
    "browseUp": "Remonter",
    "browseEmpty": "Aucun sous-dossier",
...
sklm: {
    ...
    "remoteHosts": {
      ...
      "syncTitle": "Synchroniser les modèles vers {{host}}",
      "syncDescription": "Copie les fournisseurs sélectionnés, clés d'API comprises, vers cet hôte via SSH.",
      "syncEmpty": "Aucun fournisseur ne peut être synchronisé. Les fournisseurs à connexion (OAuth) et ceux des plugins restent sur cette machine.",
      "syncLocalDefault": "Par défaut",
      "syncSetDefault": "Définir le premier fournisseur sélectionné comme défaut de l'hôte",
      "syncAction": "Synchroniser",
      "syncRunning": "Synchronisation…",
      "syncSucceeded": "Modèles synchronisés vers {{host}}.",
      "syncPartial": "Modèles synchronisés vers {{host}} ; certains fournisseurs ont été ignorés.",
      "syncFailed": "Échec de la synchronisation : {{message}}",
      "syncHint": "Synchronisez les modèles vers {{label}} avant d'y démarrer une session.",
      "experimental": "Expérimental"
    },
  ...
  "panel": {
    ...
    "review": {
      ...
      "workspaceDiff": "Arbre de travail Git",
      "workspaceNoRepo": "Le dossier de cette session n'est pas un dépôt Git.",
      "workspaceNoChanges": "Aucune modification Git en attente",
      "workspaceError": "Impossible de charger le diff Git distant.",
      "workspaceTruncated": "D'autres fichiers modifiés ne sont pas affichés.",
      "refresh": "Actualiser",
