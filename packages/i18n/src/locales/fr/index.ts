...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
    ...
    selectedExcerpts: "Texte sélectionné dans la conversation",
    removeExcerpt: "Retirer l’annotation",
    removeExcerptsBeforeCommand: "Retirez les annotations avant d’exécuter une commande.",
