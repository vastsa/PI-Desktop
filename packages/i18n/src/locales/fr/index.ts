...
sklm: {
    ...
    "queuedPromptAnimation": "Animation des messages en file",
    "queuedPromptAnimationDesc": "Mouvement sur la ligne promue (« envoi imminent ») de la file, pour qu'un message en attente se remarque. La barre d'accent elle-même ne bouge pas.",
    "queuedPromptAnimationOff": "Désactivée (par défaut)",
    "queuedPromptAnimationBubbles": "Bulles",
    "queuedPromptAnimationGlow": "Halo",
    "queuedPromptAnimationWave": "Ligne d'eau",
