...
export const ko = {
  ...
  chat: {
    ...
    excerptCount_one: "{{count}}개 주석",
    excerptCount: "{{count}}개 주석",
    excerptCount_other: "{{count}}개 주석",
    selectedExcerpts: "선택한 대화 내용",
    removeExcerpt: "주석 제거",
    removeExcerptsBeforeCommand: "명령을 실행하기 전에 주석을 제거하세요.",
