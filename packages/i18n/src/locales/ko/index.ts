...
sklm: {
    ...
    queuedPromptAnimation: "대기 메시지 애니메이션",
    queuedPromptAnimationDesc: "곧 전송될 대기 열 행에 적용되는 모션으로, 대기 중인 메시지를 눈에 띄게 합니다. 강조 바 자체는 움직이지 않습니다.",
    queuedPromptAnimationOff: "끄기(기본값)",
    queuedPromptAnimationBubbles: "버블",
    queuedPromptAnimationGlow: "광휘",
    queuedPromptAnimationWave: "물결선",
