...
export const ko = {
  ...
  remote: {
    badge: "원격",
    sidebarSection: "원격 호스트",
    connected: "연결됨",
    disconnected: "오프라인",
    newSession: "새 원격 세션",
    noSessions: "이 호스트에 세션이 없습니다",
    newSessionTitle: "{{host}}에서 새 세션",
    newSessionDescription: "호스트의 프로젝트를 선택하세요. 세션은 호스트의 기본 모델로 해당 호스트에서 실행됩니다.",
    projects: "호스트 프로젝트",
    loadingProjects: "프로젝트 불러오는 중…",
    noProjects: "이 호스트에는 아직 프로젝트가 없습니다. 폴더를 찾아 추가하세요.",
    browseFolder: "폴더 찾아보기…",
    browseDirectories: "호스트 폴더",
    browseUp: "위로",
    browseEmpty: "하위 폴더 없음",
...
sklm: {
    ...
    remoteHosts: {
      ...
      transportSsh: "SSH",
      syncModels: "모델 동기화…",
      syncTitle: "{{host}}(으)로 모델 동기화",
      syncDescription: "선택한 공급자를 API 키와 함께 SSH로 이 호스트에 복사합니다.",
      syncEmpty: "동기화할 수 있는 공급자가 없습니다. 로그인(OAuth) 공급자와 플러그인 공급자는 이 기기에만 남습니다.",
      syncLocalDefault: "기본",
      syncSetDefault: "처음 선택한 공급자를 호스트 기본값으로 설정",
      syncAction: "동기화",
      syncRunning: "동기화 중…",
      syncSucceeded: "{{host}}(으)로 모델을 동기화했습니다.",
      syncPartial: "{{host}}(으)로 모델을 동기화했습니다. 일부 공급자는 건너뛰었습니다.",
      syncFailed: "모델 동기화 실패: {{message}}",
      syncHint: "{{label}}에서 세션을 시작하기 전에 모델을 동기화하세요.",
      experimental: "실험적",
    },
  ...
  panel: {
    ...
    review: {
      ...
      workspaceDiff: "Git 작업 트리",
      workspaceNoRepo: "이 세션 폴더는 Git 저장소가 아닙니다.",
      workspaceNoChanges: "커밋되지 않은 Git 변경 사항이 없습니다",
      workspaceError: "원격 Git diff를 불러오지 못했습니다.",
      workspaceTruncated: "일부 변경 파일은 생략되었습니다.",
      refresh: "새로 고침",
      binary: "바이너리 파일",
