...
importConfirm: "가져온 확장은 에이전트 프로세스 안에서 에이전트 자체 도구와 같은 권한으로 실행됩니다. 선언된 스킬은 에이전트에 지침을 추가할 수 있고, 선언된 의존성은 npm으로 설치됩니다(설치 스크립트 비활성화). 계속할까요?",
  ...
  errors: {
    ...
    TURN_ABORTED: "중지됨",
    AGENT_SIDECAR_CRASHED: "AI 런타임이 작업 중 충돌했습니다. 이 턴은 중지되었습니다. 다시 시도하세요.",
    AGENT_SIDECAR_OOM: "이 대화가 AI 런타임의 메모리 한도를 초과했습니다. 새 대화를 시작하거나 에이전트가 처리하는 내용을 줄인 뒤 다시 시도하세요.",
  ...
  index: {
    ...
    "grepBoost": "워크스페이스 색인",
    "grepBoostDesc": "이 스위치가 켜져 있으면 새로 여는 워크스페이스가 백그라운드에서 색인되고 이 페이지에 그 상태가 표시됩니다. 모든 데이터는 이 컴퓨터에만 저장됩니다.",
    loadErrorTitle: "인덱스 상태를 사용할 수 없음",
    loadErrorDesc: "호스트가 응답하지 않습니다.",
    retry: "다시 시도",
    statusDesc: "색인은 다시 생성할 수 있는 로컬 캐시입니다.",
    indexSubtitle: "로컬 색인은 다시 생성할 수 있는 캐시입니다. 이 페이지는 그 상태와 건강도를 표시합니다.",
    nudgeText: "모든 처리는 로컬에서 이루어지며 워크스페이스 콘텐츠를 업로드하지 않습니다.",
    nudgeDismiss: "확인",
    sectionCode: "코드베이스",
    progressFiles: "{{done}} / {{total}}개 파일",
    progressFallback: "색인은 백그라운드에서 생성되며, 그동안 작업을 계속할 수 있습니다.",
    emptyTitle: "현재 워크스페이스에 인덱스가 없습니다",
    emptyDesc: "생성하면 파일 수와 크기를 볼 수 있습니다. 색인은 이 컴퓨터에만 저장됩니다.",
    actions: "인덱스 작업",
    actionsDesc: "현재 워크스페이스의 색인을 생성하거나 다시 생성합니다. 스위치가 꺼져 있으면 사용하는 기능이 없으므로 생성할 수 없습니다.",
    localOnly: "모든 데이터는 로컬에 저장되며 업로드되지 않습니다.",
    rebuilding: "색인 중…",
    clearing: "삭제 중…",
    actionError: "색인 작업이 실패했습니다. 다시 시도할 수 있습니다.",
    card: {
      health: "인덱스 상태",
      status: "상태",
      files: "색인된 파일",
