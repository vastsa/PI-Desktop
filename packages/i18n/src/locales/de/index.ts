...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    selectionActions: "Aktionen für ausgewählten Text",
    excerptCount_one: "{{count}} Anmerkung",
    excerptCount: "{{count}} Anmerkungen",
    excerptCount_other: "{{count}} Anmerkungen",
    selectedExcerpts: "Ausgewählter Gesprächstext",
    removeExcerpt: "Auswahl entfernen",
    removeExcerptsBeforeCommand: "Entferne die Anmerkungen, bevor du einen Befehl ausführst.",
