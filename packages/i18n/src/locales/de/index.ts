...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    "remoteHostModel": "Standardmodell des Hosts",
  ...
  "remote": {
    ...
    "newSession": "Neue Remote-Sitzung",
    "noSessions": "Keine Sitzungen auf diesem Host",
    "newSessionTitle": "Neue Sitzung auf {{host}}",
    "newSessionDescription": "Wähle ein Projekt auf dem Host. Die Sitzung läuft dort mit dem Standardmodell des Hosts.",
    "projects": "Host-Projekte",
    "loadingProjects": "Projekte werden geladen…",
    "noProjects": "Dieser Host hat noch keine Projekte. Durchsuche Ordner, um eines hinzuzufügen.",
    "browseFolder": "Ordner durchsuchen…",
    "browseDirectories": "Host-Ordner",
    "browseUp": "Nach oben",
    "browseEmpty": "Keine Unterordner",
...
sklm: {
    ...
    "remoteHosts": {
      ...
      "syncTitle": "Modelle mit {{host}} synchronisieren",
      "syncDescription": "Kopiert die ausgewählten Anbieter samt API-Schlüsseln per SSH auf diesen Host.",
      "syncEmpty": "Kein Anbieter kann synchronisiert werden. Anmelde- (OAuth) und Plugin-Anbieter bleiben auf diesem Gerät.",
      "syncLocalDefault": "Standard",
      "syncSetDefault": "Ersten ausgewählten Anbieter als Standard des Hosts festlegen",
      "syncAction": "Synchronisieren",
      "syncRunning": "Wird synchronisiert…",
      "syncSucceeded": "Modelle mit {{host}} synchronisiert.",
      "syncPartial": "Modelle mit {{host}} synchronisiert; einige Anbieter wurden übersprungen.",
      "syncFailed": "Synchronisierung fehlgeschlagen: {{message}}",
      "syncHint": "Synchronisiere Modelle mit {{label}}, bevor du dort eine Sitzung startest.",
      "experimental": "Experimentell"
    },
  ...
  "panel": {
    ...
    "review": {
      ...
      "workspaceDiff": "Git-Arbeitsbaum",
      "workspaceNoRepo": "Der Sitzungsordner ist kein Git-Repository.",
      "workspaceNoChanges": "Keine ausstehenden Git-Änderungen",
      "workspaceError": "Der Remote-Git-Diff konnte nicht geladen werden.",
      "workspaceTruncated": "Weitere geänderte Dateien werden nicht angezeigt.",
      "refresh": "Aktualisieren",
      "binary": "Binärdatei",
