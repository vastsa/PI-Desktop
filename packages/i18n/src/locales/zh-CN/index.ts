...
sklm: {
    ...
    queuedPromptAnimation: "排队消息动效",
    queuedPromptAnimationDesc: "应用在“即将发送”的排队消息行上的动效，让待发送的消息更显眼。左侧白色竖条本身保持不动。",
    queuedPromptAnimationOff: "关闭（默认）",
    queuedPromptAnimationBubbles: "泡泡",
    queuedPromptAnimationGlow: "柔光",
    queuedPromptAnimationWave: "水线",
