...
export const zhCN = {
  ...
  extensions: {
    ...
    subagents: {
      ...
      presetExplorerDesc: "快速检索代码库并匹配模式，一次性回答“X 在哪？”/“Y 是怎么工作的？”",
      presetReviewerName: "代码审查员",
      presetReviewerDesc: "在提交前提供关于正确性、边界用例与遗漏测试的第二意见。",
      presetTestRunnerName: "测试执行者",
      presetTestRunnerDesc: "运行指定的测试或构建命令，并报告失败原因。",
      presetFixerName: "修复者",
      presetFixerDesc: "在自己独立的上下文中，按规格完整实现一个跨多文件的改动。",
      presetBlank: "空白开始",
      presetBlankDesc: "默认工具，空白指令 — 自己撰写。",
      presetApply: "套用",
