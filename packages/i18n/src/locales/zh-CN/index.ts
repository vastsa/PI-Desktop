...
export const zhCN = {
  ...
  remote: {
    ...
    newSession: "新建远程会话",
    noSessions: "该主机暂无会话",
    newSessionTitle: "在 {{host}} 上新建会话",
    newSessionDescription: "选择主机上的项目。会话在该主机上运行，使用主机的默认模型。",
    projects: "主机项目",
    loadingProjects: "正在加载项目…",
    noProjects: "该主机还没有项目。浏览文件夹来添加一个。",
    browseFolder: "浏览文件夹…",
    browseDirectories: "主机文件夹",
    browseUp: "上一级",
    browseEmpty: "没有子文件夹",
...
sklm: {
    ...
    remoteHosts: {
      ...
      transportSsh: "SSH",
      syncModels: "同步模型…",
      syncTitle: "同步模型到 {{host}}",
      syncDescription: "通过 SSH 把选中的服务商（含 API Key）复制到这台主机。",
      syncEmpty: "没有可同步的服务商。登录授权（OAuth）和插件提供的服务商只保留在本机。",
      syncLocalDefault: "默认",
      syncSetDefault: "把第一个选中的服务商设为主机默认",
      syncAction: "同步",
      syncRunning: "正在同步…",
      syncSucceeded: "已同步模型到 {{host}}。",
      syncPartial: "已同步模型到 {{host}}，部分服务商被跳过。",
      syncFailed: "同步模型失败：{{message}}",
      syncHint: "在 {{label}} 上开始会话前，请先同步模型。",
      experimental: "实验性",
    },
    importTitle: "从其他工具导入",
    importScan: "扫描",
  ...
  panel: {
    ...
    review: {
      ...
      workspaceDiff: "Git 工作树",
      workspaceNoRepo: "该会话目录不是 Git 仓库。",
      workspaceNoChanges: "没有未提交的 Git 改动",
      workspaceError: "无法加载远程 Git 差异。",
      workspaceTruncated: "还有部分改动文件未显示。",
      refresh: "刷新",
      binary: "二进制文件",
