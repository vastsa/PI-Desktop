...
export const zhCN = {
  ...
  chat: {
    ...
    excerptCount_one: "{{count}} 条注释",
    excerptCount: "{{count}} 条注释",
    excerptCount_other: "{{count}} 条注释",
    selectedExcerpts: "已选中的会话内容",
    removeExcerpt: "移除这条注释",
    removeExcerptsBeforeCommand: "运行命令前请先移除注释。",
