...
sklm: {
  ...
  index: {
    loading: "正在读取索引状态…",
    "grepBoost": "工作区索引",
    "grepBoostDesc": "开关打开时，新打开的工作区会在后台建立索引，本页显示其状态。所有数据均保存在本机。",
    loadErrorTitle: "索引状态不可用",
    loadErrorDesc: "主机未响应。",
    retry: "重试",
    statusDesc: "索引是可重建的本地缓存。",
    indexSubtitle: "本地索引是可重建的缓存；本页显示其状态与健康度。",
    nudgeText: "所有处理均在本地完成，不会上传工作区内容。",
    nudgeDismiss: "知道了",
    sectionCode: "代码库",
    progressFiles: "{{done}} / {{total}} 个文件",
    progressFallback: "索引在后台构建，期间可继续工作。",
    emptyTitle: "当前工作区尚未建立索引",
    emptyDesc: "建立索引后可查看文件数与体积。索引仅保存在本机。",
    actions: "索引操作",
    actionsDesc: "为当前工作区建立或重建索引。开关关闭时无法建立，因为没有功能会使用它。",
    localOnly: "所有数据均存储在本地，不会上传。",
    rebuilding: "正在索引…",
    clearing: "正在清理…",
    actionError: "索引操作失败。可以重试。",
    card: {
      health: "索引健康",
      status: "状态",
      files: "已索引文件",
