...
sklm: {
  ...
  index: {
    ...
    "grepBoostDesc": "开关打开时，Grep 才可能从本工作区的索引返回区分大小写的字面量查询结果；切换到其他工作区时会在后台为它建立索引。其他查询自动回退 rg。所有数据均保存在本机。",
    loadErrorTitle: "索引状态不可用",
    loadErrorDesc: "主机未响应。没有索引时 Grep 仍正常工作。",
    retry: "重试",
    statusDesc: "索引是可重建的本地缓存；Grep 结果从不依赖它。",
    indexSubtitle: "本地索引是可重建的加速缓存；Grep 始终保留 rg 回退路径。",
    nudgeText: "这两项功能都在本地运行，不会上传工作区内容。",
    nudgeDismiss: "知道了",
    sectionCode: "代码库",
    fastPathHitRate: "快路径命中率",
    progressFiles: "{{done}} / {{total}} 个文件",
    progressFallback: "Grep 自动回退 rg，搜索不受影响。",
    emptyTitle: "当前工作区尚未建立索引",
    emptyDesc: "建立索引后可查看文件数与体积。索引仅保存在本机，且只在索引加速打开时被读取。",
    actions: "索引操作",
    actionsDesc: "为当前工作区建立或重建索引。索引加速关闭时无法建立，因为没有查询会读取它。",
    localOnly: "所有数据均存储在本地，不会上传。",
    rebuilding: "正在索引…",
    clearing: "正在清理…",
    actionError: "索引操作失败。可以重试；Grep 不受影响。",
    card: {
      health: "索引健康",
      status: "状态",
      files: "已索引文件",
