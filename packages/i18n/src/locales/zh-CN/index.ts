...
export const zhCN = {
  ...
  chat: {
    ...
    activityToolCalls: "{{count}} 次工具调用",
    activityToolCalls_other: "{{count}} 次工具调用",
    activityCommands: "{{count}} 次命令执行",
    activityCommands_other: "{{count}} 次命令执行",
    activitySearches: "{{count}} 次搜索",
    activitySearches_other: "{{count}} 次搜索",
    activityThinking: "{{count}} 次思考",
    activityThinking_other: "{{count}} 次思考",
