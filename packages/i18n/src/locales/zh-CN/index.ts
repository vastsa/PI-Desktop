...
export const zhCN = {
  ...
  settings: {
    ...
    modelCapabilities: "附件能力",
    imageInput: "图片输入",
    documentInput: "PDF 输入",
    documentInputHint: "PDF 以受限文件引用发送，模型通过文件工具读取。",
    followPublished: "跟随发布值",
    capabilityPublished: "来自目录",
    capabilityUnknown: "目录未描述",
