...
export const zhCN = {
  ...
  settings: {
    ...
    presetVolcengineCodingPlan: "火山方舟 Coding Plan",
    presetVolcengineCodingPlanOpenai: "火山方舟 Coding Plan（OpenAI）",
    presetVolcengineAgentPlan: "火山方舟 Agent Plan",
    presetVolcengineAgentPlanOpenai: "火山方舟 Agent Plan（OpenAI）",
