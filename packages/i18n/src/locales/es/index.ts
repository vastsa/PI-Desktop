...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    selectionActions: "Acciones del texto seleccionado",
    excerptCount_one: "{{count}} anotación",
    excerptCount: "{{count}} anotaciones",
    excerptCount_other: "{{count}} anotaciones",
    selectedExcerpts: "Texto seleccionado de la conversación",
    removeExcerpt: "Quitar anotación",
    removeExcerptsBeforeCommand: "Quita las anotaciones antes de ejecutar un comando.",
