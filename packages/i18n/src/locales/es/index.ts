...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
  ...
  "remote": {
    ...
    "newSession": "Nueva sesión remota",
    "noSessions": "No hay sesiones en este host",
    "newSessionTitle": "Nueva sesión en {{host}}",
    "newSessionDescription": "Elige un proyecto en el host. La sesión se ejecuta allí con el modelo predeterminado del host.",
    "projects": "Proyectos del host",
    "loadingProjects": "Cargando proyectos…",
    "noProjects": "Este host aún no tiene proyectos. Explora carpetas para añadir uno.",
    "browseFolder": "Explorar carpetas…",
    "browseDirectories": "Carpetas del host",
    "browseUp": "Subir",
    "browseEmpty": "Sin subcarpetas",
...
sklm: {
    ...
    "remoteHosts": {
      ...
      "syncTitle": "Sincronizar modelos con {{host}}",
      "syncDescription": "Copia los proveedores seleccionados, con sus claves de API, a este host por SSH.",
      "syncEmpty": "No hay proveedores que se puedan sincronizar. Los de inicio de sesión (OAuth) y los de plugins se quedan en este equipo.",
      "syncLocalDefault": "Predeterminado",
      "syncSetDefault": "Usar el primer proveedor seleccionado como predeterminado del host",
      "syncAction": "Sincronizar",
      "syncRunning": "Sincronizando…",
      "syncSucceeded": "Modelos sincronizados con {{host}}.",
      "syncPartial": "Modelos sincronizados con {{host}}; se omitieron algunos proveedores.",
      "syncFailed": "Error al sincronizar modelos: {{message}}",
      "syncHint": "Sincroniza los modelos con {{label}} antes de iniciar una sesión allí.",
      "experimental": "Experimental"
    },
  ...
  "panel": {
    ...
    "review": {
      ...
      "workspaceDiff": "Árbol de trabajo de Git",
      "workspaceNoRepo": "La carpeta de esta sesión no es un repositorio de Git.",
      "workspaceNoChanges": "No hay cambios de Git pendientes",
      "workspaceError": "No se pudo cargar la diferencia de Git remota.",
      "workspaceTruncated": "Se omitieron otros archivos modificados.",
      "refresh": "Actualizar",
