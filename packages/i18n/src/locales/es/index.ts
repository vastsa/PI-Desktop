...
sklm: {
    ...
    "queuedPromptAnimation": "Animación de mensajes en cola",
    "queuedPromptAnimationDesc": "Movimiento en la fila destacada (\"enviar a continuación\") de la cola para que un mensaje pendiente destaque. La barra de acento no se mueve.",
    "queuedPromptAnimationOff": "Desactivada (predeterminada)",
    "queuedPromptAnimationBubbles": "Burbujas",
    "queuedPromptAnimationGlow": "Brillo",
    "queuedPromptAnimationWave": "Línea de agua",
