...
export const zhTW = {
  ...
  chat: {
    ...
    excerptCount_one: "{{count}} 則註解",
    excerptCount: "{{count}} 則註解",
    excerptCount_other: "{{count}} 則註解",
    selectedExcerpts: "已選取的對話內容",
    removeExcerpt: "移除這則註解",
    removeExcerptsBeforeCommand: "執行指令前請先移除註解。",
