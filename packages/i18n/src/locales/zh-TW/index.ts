...
sklm: {
  ...
  index: {
    loading: "正在讀取索引狀態…",
    "grepBoost": "索引加速 Grep（測試版）",
    "grepBoostDesc": "開關開啟時，Grep 才可能從本工作區的索引回傳區分大小寫的字面量查詢結果；切換到其他工作區時會在背景為它建立索引。其他查詢自動回退 rg。所有資料均保存在本機。",
    loadErrorTitle: "索引狀態不可用",
    loadErrorDesc: "主機未回應。沒有索引時 Grep 仍正常運作。",
    retry: "重試",
    statusDesc: "索引是可重建的本機快取；Grep 結果從不依賴它。",
    indexSubtitle: "本機索引是可重建的加速快取；Grep 始終保留 rg 回退路徑。",
    nudgeText: "這兩項功能都在本機執行，不會上傳工作區內容。",
    nudgeDismiss: "知道了",
    sectionCode: "程式碼庫",
    fastPathHitRate: "快路徑命中率",
    progressFiles: "{{done}} / {{total}} 個檔案",
    progressFallback: "Grep 自動回退 rg，搜尋不受影響。",
    emptyTitle: "目前工作區尚未建立索引",
    emptyDesc: "建立索引後可查看檔案數與大小。索引僅保存在本機，且只在索引加速開啟時被讀取。",
    actions: "索引操作",
    actionsDesc: "為目前工作區建立或重建索引。索引加速關閉時無法建立，因為沒有查詢會讀取它。",
    localOnly: "所有資料均儲存在本機，不會上傳。",
    rebuilding: "正在索引…",
    clearing: "正在清除…",
    actionError: "索引操作失敗。可以重試；Grep 不受影響。",
    card: {
      health: "索引健康",
      status: "狀態",
      files: "已索引檔案",
