...
sklm: {
    ...
    queuedPromptAnimation: "排隊訊息動效",
    queuedPromptAnimationDesc: "套用於「即將傳送」的排隊訊息行上的動效，讓待傳送的訊息更顯眼。左側白色長條本身保持不動。",
    queuedPromptAnimationOff: "關閉（預設）",
    queuedPromptAnimationBubbles: "泡泡",
    queuedPromptAnimationGlow: "柔光",
    queuedPromptAnimationWave: "水線",
