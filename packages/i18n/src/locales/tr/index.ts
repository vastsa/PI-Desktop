...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
  ...
  index: {
    ...
    "grepBoostDesc": "Bu anahtar açıkken Grep bu çalışma alanının dizininden büyük-küçük harfe duyarlı hazır değer aramalarını sunabilir; başka bir çalışma alanına geçtiğinizde onun dizini arka planda oluşturulur. Diğerleri rg'ye geri döner. Her şey bu makinede kalır.",
    loadErrorTitle: "Dizin durumu kullanılamıyor",
    loadErrorDesc: "Ana makine yanıt vermedi. Dizin olmadan da Grep çalışır.",
    retry: "Yeniden dene",
    statusDesc: "Dizin yeniden oluşturulabilir yerel bir önbellektir; Grep sonuçları ona asla bağlı değildir.",
    indexSubtitle: "Yerel dizin yeniden oluşturulabilir bir hızlandırma önbelleğidir; Grep her zaman rg'ye geri dönüş yolunu korur.",
    nudgeText: "Her iki özellik de yerel olarak çalışır ve çalışma alanı içeriğini yüklemez.",
    nudgeDismiss: "Anladım",
    sectionCode: "Kod tabanı",
    fastPathHitRate: "Hızlı yol isabet oranı",
    progressFiles: "{{done}} / {{total}} dosya",
    progressFallback: "Grep otomatik olarak rg'ye geri döner; arama etkilenmez.",
    emptyTitle: "Geçerli çalışma alanı için dizin yok",
    emptyDesc: "Oluşturduğunuzda dosya sayısını ve boyutu görürsünüz. Dizin bu makinede kalır ve yalnızca dizin hızlandırma açıkken okunur.",
    actions: "Dizin işlemleri",
    actionsDesc: "Geçerli çalışma alanının dizinini oluşturur veya yeniden oluşturur. Dizin hızlandırma kapalıyken oluşturulamaz, çünkü onu okuyacak bir şey yoktur.",
    localOnly: "Her şey yerel saklanır, asla yüklenmez.",
    rebuilding: "Dizinleniyor…",
    clearing: "Temizleniyor…",
    actionError: "İşlem başarısız. Yeniden deneyebilirsiniz; Grep etkilenmez.",
    card: {
      health: "Dizin durumu",
      status: "Durum",
      files: "Dizinlenen dosyalar",
      size: "Dizin boyutu",
      errors: "Okunamayan dosyalar",
      updated: "Son güncelleme",
    },
    action: {
      rebuild: "Dizini yeniden oluştur",
      build: "Dizin oluştur",
      clear: "Dizini temizle",
    },
    status: {
      fresh: "Hazır",
      ...
      partial: "Kısmi",
      disabled: "Kapalı",
      skipped_over_limit: "Bütçe aşıldı",
    },
  },
