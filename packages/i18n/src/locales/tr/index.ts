...
export const tr = {
  ...
  remote: {
    badge: "Uzak",
    sidebarSection: "Uzak ana makineler",
    connected: "Bağlı",
    disconnected: "Çevrimdışı",
    newSession: "Yeni uzak oturum",
    noSessions: "Bu ana makinede oturum yok",
    newSessionTitle: "{{host}} üzerinde yeni oturum",
    newSessionDescription: "Ana makinede bir proje seçin. Oturum orada, ana makinenin varsayılan modeliyle çalışır.",
    projects: "Ana makine projeleri",
    loadingProjects: "Projeler yükleniyor…",
    noProjects: "Bu ana makinede henüz proje yok. Eklemek için klasörlere göz atın.",
    browseFolder: "Klasörlere göz at…",
    browseDirectories: "Ana makine klasörleri",
    browseUp: "Yukarı",
    browseEmpty: "Alt klasör yok",
...
sklm: {
    ...
    remoteHosts: {
      ...
      syncTitle: "Modelleri {{host}} ile eşitle",
      syncDescription: "Seçili sağlayıcıları API anahtarlarıyla birlikte SSH üzerinden bu ana makineye kopyalar.",
      syncEmpty: "Eşitlenebilecek sağlayıcı yok. Oturum açmalı (OAuth) ve eklenti sağlayıcıları bu makinede kalır.",
      syncLocalDefault: "Varsayılan",
      syncSetDefault: "İlk seçilen sağlayıcıyı ana makinenin varsayılanı yap",
      syncAction: "Eşitle",
      syncRunning: "Eşitleniyor…",
      syncSucceeded: "Modeller {{host}} ile eşitlendi.",
      syncPartial: "Modeller {{host}} ile eşitlendi; bazı sağlayıcılar atlandı.",
      syncFailed: "Model eşitleme başarısız: {{message}}",
      syncHint: "{{label}} üzerinde oturum başlatmadan önce modelleri eşitleyin.",
      experimental: "Deneysel",
    },
  ...
  panel: {
    ...
    review: {
      ...
      workspaceDiff: "Git çalışma ağacı",
      workspaceNoRepo: "Bu oturumun klasörü bir Git deposu değil.",
      workspaceNoChanges: "Bekleyen Git değişikliği yok",
      workspaceError: "Uzak Git farkı yüklenemedi.",
      workspaceTruncated: "Ek değiştirilen dosyalar gösterilmiyor.",
      refresh: "Yenile",
      binary: "İkili dosya",
