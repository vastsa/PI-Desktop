...
export const tr = {
  ...
  chat: {
    ...
    selectionActions: "Seçili metin işlemleri",
    excerptCount_one: "{{count}} not",
    excerptCount: "{{count}} not",
    excerptCount_other: "{{count}} not",
    selectedExcerpts: "Seçilen konuşma metni",
    removeExcerpt: "Notu kaldır",
    removeExcerptsBeforeCommand: "Komutu çalıştırmadan önce notları kaldırın.",
