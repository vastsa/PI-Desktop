...
sklm: {
    ...
    acpSection: "Harici ajan",
    acpEnable: "Bu servisi harici ajan olarak çalıştır (ACP)",
    acpExplanation:
      "Harici ajan, kendi modelleri ve kimlik bilgileriyle gelen bu makinedeki bir programdır. Aşağıdaki URL, API biçimi ve API anahtarı kullanılmaz.",
    acpChoosePreset: "Bir ajan seç",
    acpCommand: "Komut",
    acpArgs: "Argümanlar",
