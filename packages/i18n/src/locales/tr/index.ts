...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
  ...
  index: {
    ...
    "grepBoost": "Çalışma alanı dizinleme",
    "grepBoostDesc": "Bu anahtar açıkken yeni açılan çalışma alanları arka planda dizinlenir ve bu sayfa durumlarını gösterir. Her şey bu makinede kalır.",
    loadErrorTitle: "Dizin durumu kullanılamıyor",
    loadErrorDesc: "Ana makine yanıt vermedi.",
    retry: "Yeniden dene",
    statusDesc: "Dizin yeniden oluşturulabilen yerel bir önbellektir.",
    indexSubtitle: "Yerel dizin yeniden oluşturulabilen bir önbellektir; bu sayfa durumunu ve sağlığını gösterir.",
    nudgeText: "Her şey yerel olarak çalışır ve çalışma alanı içeriğinizi asla yüklemez.",
    nudgeDismiss: "Anladım",
    sectionCode: "Kod tabanı",
    progressFiles: "{{done}} / {{total}} dosya",
    progressFallback: "Dizin arka planda oluşturulur; çalışmaya devam edebilirsiniz.",
    emptyTitle: "Geçerli çalışma alanı için dizin yok",
    emptyDesc: "Dosya sayısını ve boyutu görmek için bir tane oluşturun. Dizin bu makinede kalır.",
    actions: "Dizin işlemleri",
    actionsDesc: "Geçerli çalışma alanının dizinini oluşturur veya yeniden oluşturur. Anahtar kapalıyken oluşturulamaz, çünkü hiçbir şey onu kullanmazdı.",
    localOnly: "Her şey yerel saklanır, asla yüklenmez.",
    rebuilding: "Dizinleniyor…",
    clearing: "Temizleniyor…",
    actionError: "Dizin eylemi başarısız oldu. Yeniden deneyebilirsiniz.",
    card: {
      health: "Dizin durumu",
      status: "Durum",
