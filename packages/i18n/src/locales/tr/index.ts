...
sklm: {
    ...
    queuedPromptAnimation: "Kuyruğa alınmış mesaj animasyonu",
    queuedPromptAnimationDesc: "Sıradaki (\"hemen gönderilecek\") satırda bekleyen bir mesajın öne çıkması için gösterilen hareket. Vurgu çubuğunun kendisi hareket etmez.",
    queuedPromptAnimationOff: "Kapalı (varsayılan)",
    queuedPromptAnimationBubbles: "Kabarcık",
    queuedPromptAnimationGlow: "Parıltı",
    queuedPromptAnimationWave: "Su çizgisi",
