...
sklm: {
    ...
    queuedPromptAnimation: "Queued message animation",
    queuedPromptAnimationDesc: "Motion shown on the promoted (\"send now pending\") queue row so a pending message stands out. The accent bar itself never moves.",
    queuedPromptAnimationOff: "Off (default)",
    queuedPromptAnimationBubbles: "Bubbles",
    queuedPromptAnimationGlow: "Glow",
    queuedPromptAnimationWave: "Waterline",
