...
sklm: {
    ...
    acpSection: "External agent",
    acpEnable: "Run this service as an external agent (ACP)",
    acpExplanation:
      "An external agent is a program on this machine that brings its own models and credentials. The URL, API format and API key below are not used.",
    acpChoosePreset: "Pick an agent",
    acpCommand: "Command",
    acpArgs: "Arguments",
