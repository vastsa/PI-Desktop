export const en = {
  ...
  extensions: {
    ...
    subagents: {
      ...
      presetExplorerDesc: "Fast codebase search and pattern matching — answers “where is X?” / “how does Y work?” in one sweep.",
      presetReviewerName: "Code reviewer",
      presetReviewerDesc: "Second opinion on correctness, edge cases and missing tests before a commit.",
      presetTestRunnerName: "Test runner",
      presetTestRunnerDesc: "Run a specific test or build command and report what failed and why.",
      presetFixerName: "Fixer",
      presetFixerDesc: "Implement a complete multi-file change from a spec inside its own context.",
      presetBlank: "Start blank",
      presetBlankDesc: "Default tools, blank instructions — write your own.",
      presetApply: "Apply",
