export const en = {
  ...
  chat: {
    ...
    excerptCount_one: "{{count}} annotation",
    excerptCount: "{{count}} annotations",
    excerptCount_other: "{{count}} annotations",
    selectedExcerpts: "Selected conversation text",
    removeExcerpt: "Remove selected text",
    removeExcerptsBeforeCommand: "Remove selected text before running a command.",
