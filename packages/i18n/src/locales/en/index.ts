export const en = {
  ...
  settings: {
    ...
    capabilityNoMatchesHint: "Try another term, or switch the level filter.",
    ...
    documentInput: "PDF input",
    documentInputHint:
      "PDFs are sent as bounded file references, so the model reads them with its file tools.",
    followPublished: "Follow published",
    capabilityPublished: "from catalog",
    capabilityUnknown: "not described",
