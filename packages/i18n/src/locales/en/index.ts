export const en = {
  ...
  remote: {
    badge: "Remote",
    sidebarSection: "Remote hosts",
    connected: "Connected",
    disconnected: "Offline",
    newSession: "New remote session",
    noSessions: "No sessions on this host",
    newSessionTitle: "New session on {{host}}",
    newSessionDescription: "Pick a project on the host. The session runs there with the host's default model.",
    projects: "Host projects",
    loadingProjects: "Loading projects…",
    noProjects: "This host has no projects yet. Browse for a folder to add one.",
    browseFolder: "Browse folders…",
    browseDirectories: "Host folders",
    browseUp: "Up",
...
sklm: {
    ...
    remoteHosts: {
      ...
      syncTitle: "Sync models to {{host}}",
      syncDescription: "Copies the selected providers, API keys included, to this host over SSH.",
      syncEmpty: "No provider can be synced. Sign-in (OAuth) and plugin providers stay on this machine.",
      syncLocalDefault: "Default",
      syncSetDefault: "Make the first selected provider the host's default",
      syncAction: "Sync",
      syncRunning: "Syncing…",
      syncSucceeded: "Models synced to {{host}}.",
      syncPartial: "Models synced to {{host}}; some providers were skipped.",
      syncFailed: "Model sync failed: {{message}}",
      syncHint: "Sync models to {{label}} before starting a session there.",
  ...
  panel: {
    ...
    review: {
      ...
      workspaceDiff: "Git working tree",
      workspaceNoRepo: "This session's folder isn't a Git repository.",
      workspaceNoChanges: "No pending Git changes",
      workspaceError: "Couldn't load the remote Git diff.",
      workspaceTruncated: "Additional changed files are omitted.",
      refresh: "Refresh",
      binary: "Binary file",
