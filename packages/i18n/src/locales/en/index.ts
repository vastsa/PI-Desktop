...
sklm: {
    ...
    thinkingDisplayModeDesc: "Detailed shows progress in an expandable process with nested tool groups and reasoning. Compact starts the process collapsed and hides reasoning. Auto (ChatGPT style) expands while thinking and collapses when answers start.",
    thinkingDisplayDetailed: "Detailed (default)",
    thinkingDisplayCompact: "Compact",
    thinkingDisplayAuto: "Auto (ChatGPT style)",
