...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  index: {
    ...
    grepBoost: "Workspace indexing",
    grepBoostDesc: "While this switch is on, newly opened workspaces are indexed in the background and this page reports their status. Everything stays on this machine.",
    loadErrorTitle: "Index status unavailable",
    loadErrorDesc: "The host did not answer.",
    retry: "Retry",
    statusDesc: "The index is a rebuildable local cache.",
    indexSubtitle: "The local index is a rebuildable cache; this page reports its status and health.",
    nudgeText: "Everything runs locally and never uploads your workspace content.",
    nudgeDismiss: "Dismiss",
    sectionCode: "Codebase",
    progressFiles: "{{done}} / {{total}} files",
    progressFallback: "The index builds in the background; you can keep working.",
    emptyTitle: "No index for the current workspace",
    emptyDesc: "Build one to see file counts and size. The index stays on this machine.",
    actions: "Index actions",
    actionsDesc: "Build or rebuild the index for the current workspace. It cannot be built while the switch is off, because nothing would use it.",
    localOnly: "Everything is stored locally and never uploaded.",
    rebuilding: "Indexing…",
    clearing: "Clearing…",
    actionError: "The index action failed. You can retry.",
    card: {
      health: "Index health",
      status: "Status",
      files: "Indexed files",
