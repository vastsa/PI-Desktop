...
export const IPC = {
  invoke: {
    ...
    projectMemoryEditorGet: "pi-desktop/project/memory/editor/get",
    projectMemoryEditorSave: "pi-desktop/project/memory/editor/save",
    projectAutoMemorySetEnabled: "pi-desktop/project/auto-memory/set-enabled",
