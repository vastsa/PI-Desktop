...
export const SETTINGS_NAV: SettingsNavEntry[] = [
  ...
  },
  {
    ...
    keywordKeys: [
      ...
      "settings.queuedPromptAnimationDesc",
      "settings.queuedPromptAnimationOff",
      "settings.queuedPromptAnimationBubbles",
      "settings.queuedPromptAnimationGlow",
      "settings.queuedPromptAnimationWave",
