...
- **Agent-to-agent collaboration.** Coordinate concurrent subagents over the local Agent2Agent (A2A) protocol, including across open sessions: discover running peers as Agent Cards, exchange durable tasks and typed messages, and stream task updates.
